        ...
        <div className="sidebar-color-primary p-2 h-100">
          <div className="p-1">
            ...
            <div className="nav flex-column nav-pills" style={{overflow: 'hidden'}} id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <NavLink className="nav-link text-light btn" style={{outline: 'none', boxShadow: 'none'}} activeClassName="sidebar-color-secondary" to="/company/overview/">
                ...
                <NavLink className="nav-link text-light btn" style={{outline: 'none', boxShadow: 'none'}} activeClassName="sidebar-color-secondary" to="/company/map/">
                  <div className="d-inline-flex w-100 justify-content-center justify-content-lg-start">
                ...
                <NavLink className="nav-link text-light btn" style={{outline: 'none', boxShadow: 'none'}} activeClassName="sidebar-color-secondary" to="/company/employers/">
                  <div className="d-inline-flex w-100 justify-content-center justify-content-lg-start">
                ...
                <NavLink className="nav-link text-light btn" style={{outline: 'none', boxShadow: 'none'}} activeClassName="sidebar-color-secondary" to="/company/profile/"> 
                  <div className="d-inline-flex w-100 justify-content-center justify-content-lg-start">
