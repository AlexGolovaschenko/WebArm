# Generated by Django 3.1.1 on 2020-10-13 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_type', models.CharField(choices=[('BOOL', 'BOOL'), ('STRING', 'STRING'), ('FLOAT', 'FLOAT'), ('INT', 'INT')], max_length=20, verbose_name='Тип данных')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('protocol_type', models.CharField(choices=[('ASCII', 'MODBUS-ASCII'), ('RTU', 'MODBUS-RTU'), ('TCP', 'MODBUS-TCP')], default='RTU', max_length=5, verbose_name='Протокол')),
                ('device_address', models.PositiveSmallIntegerField(default=1, verbose_name='Адрес устройства')),
                ('boudrate', models.PositiveSmallIntegerField(choices=[(38400, '38400'), (300, '300'), (2400, '2400'), (14400, '14400'), (28800, '28800'), (600, '600'), (19200, '19200'), (57600, '57600'), (9600, '9600'), (1200, '1200'), (115200, '115200'), (4800, '4800')], default=9600, verbose_name='Скорость обмена данными')),
                ('address_size', models.CharField(choices=[('8', '8')], default='8', max_length=1, verbose_name='Длинна адреса')),
                ('parity', models.CharField(choices=[('odd', 'odd'), ('none', 'none'), ('even', 'even')], default='none', max_length=4, verbose_name='Контроль четности')),
